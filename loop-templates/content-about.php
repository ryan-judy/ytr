	...
	<div class="container">
	  ...
	  <ul class="timeline">
	    <li>
	      ...
	      <div class="timeline-panel sr-button">
...
<section class = "component-red component-background">
		...
		<div class = "row">
			...
			<div class = "col-lg-2 text-center sr-icons pt-4">
...
<div class = "component component-background" style="background-image: url(<?php the_field('component-background'); ?>);">
		...
		<div class = "row">
			...
			<div class = "col-lg-5 order-lg-1 order-12 pl-5 pr-2">
				...
				<div class="d-flex align-items-center"><i class = "fa fa-heartbeat sr-icons fa-3x pr-3 text-brand"></i>
					<h4 class="pt-3 text-dark"><?php the_field('career_content_2'); ?></h4>
				</div>
				<div class="d-flex align-items-center pl-3"><i class = "fa fa-dollar sr-icons fa-3x pr-3 text-brand"></i>
